                        ...
                        <a href="/detail/{{ $row->nama_kendaraan }}">
                                ...
                                <div
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <span class="text-lg font-bold text-yellow-600 ">{{ $row->harga }}</span>
                            ...
                            <div class="xl:w-1/4 md:w-1/2 sm:w-1/1 p-4 mx-auto"> 
                                ...
                                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <div class="relative overflow-hidden bg-no-repeat bg-cover">
                                            <img class=" rounded w-full object-cover hover:scale-110 transition duration-300 ease-in-out  object-center  " src="{{ asset('images/mobil/' . $row->image) }}" alt="content">
                                        </div>
